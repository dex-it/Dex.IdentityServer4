...
internal static class Constants
{
    ...
    public static readonly FrozenDictionary<string, string> ResponseTypeToGrantTypeMapping =
    ...
    public static readonly FrozenDictionary<string, ScopeRequirement> ResponseTypeToScopeRequirement =
        new Dictionary<string, ScopeRequirement>
        {
    ...
    public static readonly FrozenDictionary<string, string[]> AllowedResponseModesForGrantType =
        new Dictionary<string, string[]>
        {
            {
                GrantType.AuthorizationCode, [
    ...
    public static readonly FrozenDictionary<string, int> ProtectedResourceErrorStatusCodes = new Dictionary<string, int>
    {
    ...
    public static readonly FrozenDictionary<string, string[]> ScopeToClaimsMapping = new Dictionary<string, string[]>
    {
        {
    ...
    public class Filters
    {
        ...
        public static readonly FrozenSet<string> ProtocolClaimsFilter = new[]
        {
        ...
        public static readonly FrozenSet<string> ClaimsServiceFilterClaimTypes = new[]
        {
        ...
        public static readonly FrozenSet<string> JwtRequestClaimTypesFilter = new[]
        {
            JwtClaimTypes.Audience,
            JwtClaimTypes.Expiration,
            JwtClaimTypes.IssuedAt,
