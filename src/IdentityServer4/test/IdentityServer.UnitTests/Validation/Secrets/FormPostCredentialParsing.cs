...
public class FormPostCredentialExtraction
{
    ...
    [Fact]
    [Trait("Category", Category)]
    public async System.Threading.Tasks.ValueTask Valid_PostBody()
    {
        var context = new DefaultHttpContext();
    ...
    [Fact]
    [Trait("Category", Category)]
    public async System.Threading.Tasks.ValueTask ClientId_Too_Long()
    {
        var context = new DefaultHttpContext();
    ...
    [Fact]
    [Trait("Category", Category)]
    public async System.Threading.Tasks.ValueTask ClientSecret_Too_Long()
    {
        var context = new DefaultHttpContext();
    ...
    [Fact]
    [Trait("Category", Category)]
    public async System.Threading.Tasks.ValueTask Missing_ClientId()
    {
        var context = new DefaultHttpContext();
    ...
    [Fact]
    [Trait("Category", Category)]
    public async System.Threading.Tasks.ValueTask Missing_ClientSecret()
    {
        var context = new DefaultHttpContext();
