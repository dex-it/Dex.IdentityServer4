...
public class BasicAuthenticationSecretParsing
{
    ...
    [Fact]
    [Trait("Category", Category)]
    public async System.Threading.Tasks.ValueTask Valid_BasicAuthentication_Request()
    {
        var context = new DefaultHttpContext();
    ...
    [Fact]
    [Trait("Category", Category)]
    public async System.Threading.Tasks.ValueTask Valid_BasicAuthentication_Request_With_UserName_Only_And_Colon_For_Optional_ClientSecret()
    {
        var context = new DefaultHttpContext();
    ...
    [Fact]
    [Trait("Category", Category)]
    public async System.Threading.Tasks.ValueTask BasicAuthentication_Request_With_Empty_Basic_Header()
    {
        var context = new DefaultHttpContext();
    ...
    [Fact]
    [Trait("Category", Category)]
    public async System.Threading.Tasks.ValueTask Valid_BasicAuthentication_Request_ClientId_Too_Long()
    {
        var context = new DefaultHttpContext();
    ...
    [Fact]
    [Trait("Category", Category)]
    public async System.Threading.Tasks.ValueTask Valid_BasicAuthentication_Request_ClientSecret_Too_Long()
    {
        var context = new DefaultHttpContext();
    ...
    [Fact]
    [Trait("Category", Category)]
    public async System.Threading.Tasks.ValueTask BasicAuthentication_Request_With_Empty_Basic_Header_Variation()
    {
        var context = new DefaultHttpContext();
    ...
    [Fact]
    [Trait("Category", Category)]
    public async System.Threading.Tasks.ValueTask BasicAuthentication_Request_With_Unknown_Scheme()
    {
        var context = new DefaultHttpContext();
    ...
    [Fact]
    [Trait("Category", Category)]
    public async System.Threading.Tasks.ValueTask BasicAuthentication_Request_With_Malformed_Credentials_NoBase64_Encoding()
    {
        var context = new DefaultHttpContext();
    ...
    [Fact]
    [Trait("Category", Category)]
    public async System.Threading.Tasks.ValueTask BasicAuthentication_Request_With_Malformed_Credentials_Base64_Encoding_UserName_Only()
    {
        var context = new DefaultHttpContext();
