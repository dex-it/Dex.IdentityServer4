...
internal static class Factory
{
        ...
        IResourceValidator resourceValidator = null)
    {
        ...
        {
            aggregateExtensionGrantValidator = new ExtensionGrantValidator([new TestGrantValidator()],
        ...
        SecurityKeyInfo[] keys = null)
    {
        ...
        var validator = new TokenValidator(
            ...
            keys: new DefaultKeyMaterialService([new InMemoryValidationKeysStore(keys)],
                []),
            logger: logger,
            options: options,
            context: context);
