...
public class ResourceValidation
{
    ...
    private Client _restrictedClient = new()
    {
        ClientId = "restricted",
    ...
    public Task  Parse_Scopes_with_Empty_Scope_List()
    {
    ...
    [Fact]
    [Trait("Category", Category)]
    public Task  Parse_Scopes_with_Sorting()
    {
    ...
    [Fact]
    [Trait("Category", Category)]
    public Task  Parse_Scopes_with_Extra_Spaces()
    {
        var scopes = "   scope3     scope2     scope1   ".ParseScopesString();
    ...
    [Fact]
    [Trait("Category", Category)]
    public Task  Parse_Scopes_with_Duplicate_Scope()
    {
    ...
    public async Task Scope_matches_multipls_apis_should_succeed()
    {
        ...
        result.Resources.ApiResources.Select(x => x.Name).Should().BeEquivalentTo("api1", "api2");
        result.RawScopeValues.Count().Should().Be(1);
        result.RawScopeValues.Should().BeEquivalentTo("resource");
    }
}