...
public class CheckSessionResultTests
{
    ...
    public async Task should_pass_results_in_body()
    {
        ...
        _context.Response.Headers.ContentSecurityPolicy.First().Should().Contain("script-src 'sha256-fa5rxHhZ799izGRP38+h4ud5QXNT0SFaFlh4eqDumBI='");
    ...
    public async Task form_post_mode_should_add_unsafe_inline_for_csp_level_1()
    {
        ...
        _context.Response.Headers.ContentSecurityPolicy.First().Should().Contain("script-src 'unsafe-inline' 'sha256-fa5rxHhZ799izGRP38+h4ud5QXNT0SFaFlh4eqDumBI='");
