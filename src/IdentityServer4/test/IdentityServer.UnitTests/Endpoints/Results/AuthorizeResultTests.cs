...
{
    private readonly AuthorizeResult _subject;

    private readonly AuthorizeResponse _response = new();
    ...
    public async Task prompt_none_errors_should_return_to_client(string error)
    {
        ...
        _mockUserSession.Clients.Length.Should().Be(0);
        _context.Response.StatusCode.Should().Be(302);
        var location = _context.Response.Headers.Location.First();
    ...
    public async Task form_post_mode_should_pass_results_in_body()
    {
        ...
        _context.Response.Headers.ContentSecurityPolicy.First().Should().Contain("script-src 'sha256-orD0/VhH8hLqrLxKHD/HUEMdwqX6/0ve7c5hspX5VJ8='");
    ...
    public async Task form_post_mode_should_add_unsafe_inline_for_csp_level_1()
    {
        ...
        _context.Response.Headers.ContentSecurityPolicy.First().Should().Contain("script-src 'unsafe-inline' 'sha256-orD0/VhH8hLqrLxKHD/HUEMdwqX6/0ve7c5hspX5VJ8='");
