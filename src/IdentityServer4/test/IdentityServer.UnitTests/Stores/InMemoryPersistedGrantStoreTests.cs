...
public class InMemoryPersistedGrantStoreTests
{
    ...
    public async Task GetAll_should_filter()
    {
        ...
        (await _subject.GetAllAsync(new PersistedGrantFilter
            ...
            .Select(x => x.Key).Should().BeEquivalentTo("key1", "key2", "key3", "key4", "key5", "key6");

        (await _subject.GetAllAsync(new PersistedGrantFilter
            {
                SubjectId = "sub2"
            }))
            .Select(x => x.Key).Should().BeEquivalentTo("key7");
        ...
        (await _subject.GetAllAsync(new PersistedGrantFilter
            ...
            .Select(x => x.Key).Should().BeEquivalentTo("key1", "key3");
        ...
        (await _subject.GetAllAsync(new PersistedGrantFilter
            ...
            .Select(x => x.Key).Should().BeEquivalentTo("key2");
        ...
        (await _subject.GetAllAsync(new PersistedGrantFilter
            ...
            .Select(x => x.Key).Should().BeEquivalentTo("key4");
        ...
        (await _subject.GetAllAsync(new PersistedGrantFilter
            ...
            .Select(x => x.Key).Should().BeEquivalentTo("key5", "key6");
        ...
        (await _subject.GetAllAsync(new PersistedGrantFilter
            ...
            .Select(x => x.Key).Should().BeEquivalentTo("key1");
        ...
        (await _subject.GetAllAsync(new PersistedGrantFilter
            ...
            .Select(x => x.Key).Should().BeEquivalentTo("key3");
        ...
        (await _subject.GetAllAsync(new PersistedGrantFilter
            ...
            .Select(x => x.Key).Should().BeEquivalentTo("key6");
