...
public class DefaultTokenServiceTests
{
    ...
    private MockClaimsService _mockClaimsService = new();
    private MockReferenceTokenStore _mockReferenceTokenStore = new();
    private MockTokenCreationService _mockTokenCreationService = new();
    private DefaultHttpContext _httpContext = new();
    private MockSystemClock _mockSystemClock = new();
    private MockKeyMaterialService _mockKeyMaterialService = new();
