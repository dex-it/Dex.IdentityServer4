...
public class DefaultIdentityServerInteractionServiceTests
{
    ...
    private MockMessageStore<LogoutNotificationContext> _mockEndSessionStore = new();
    private MockMessageStore<LogoutMessage> _mockLogoutMessageStore = new();
    private MockMessageStore<ErrorMessage> _mockErrorMessageStore = new();
    private MockConsentMessageStore _mockConsentStore = new();
    private MockPersistedGrantService _mockPersistedGrantService = new();
    private MockUserSession _mockUserSession = new();
    private MockReturnUrlParser _mockReturnUrlParser = new();
    ...
    {
        await _mockUserSession.AddClientIdAsync("foo");
