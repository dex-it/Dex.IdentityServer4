...
public class EndpointRouterTests
{
    ...
    [Fact]
    public Task Endpoint_ctor_requires_path_to_start_with_slash()
    {
    ...
    [Fact]
    public Task Find_should_return_null_for_incorrect_path()
    {
    ...
    [Fact]
    public Task Find_should_find_path()
    {
        _endpoints.Add(new IdentityServer4.Hosting.Endpoint("ep1", "/ep1", typeof(MyEndpointHandler)));
        _endpoints.Add(new IdentityServer4.Hosting.Endpoint("ep2", "/ep2", typeof(MyOtherEndpointHandler)));
    ...
    [Fact]
    public Task Find_should_not_find_nested_paths()
    {
        _endpoints.Add(new IdentityServer4.Hosting.Endpoint("ep1", "/ep1", typeof(MyEndpointHandler)));
        _endpoints.Add(new IdentityServer4.Hosting.Endpoint("ep2", "/ep2", typeof(MyOtherEndpointHandler)));
    ...
    [Fact]
    public Task Find_should_find_first_registered_mapping()
    {
        _endpoints.Add(new IdentityServer4.Hosting.Endpoint("ep1", "/ep1", typeof(MyEndpointHandler)));
    ...
    [Fact]
    public Task Find_should_return_null_for_disabled_endpoint()
    {
