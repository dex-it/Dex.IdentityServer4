...
public class IdentityServerBuilderExtensionsCacheStoreTests
{
    ...
    [Fact]
    public Task AddClientStoreCache_should_add_concrete_iclientstore_implementation()
    {
    ...
    [Fact]
    public Task AddResourceStoreCache_should_attempt_to_register_iresourcestore_implementation()
    {
        var services = new ServiceCollection();
        var identityServerBuilder = new IdentityServerBuilder(services);
