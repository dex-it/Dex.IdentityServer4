...
public class JwtPayloadCreationTests
{
    ...
    public JwtPayloadCreationTests()
    {
        var claims = new List<Claim>
        {
            ...
            new(JwtClaimTypes.Scope, "scope2"),
            new(JwtClaimTypes.Scope, "scope3"),
        };
    ...
    [Fact]
    public Task Should_create_scopes_as_array_by_default()
    {
    ...
    [Fact]
    public Task Should_create_scopes_as_string()
    {
        var options = new IdentityServerOptions
        {
