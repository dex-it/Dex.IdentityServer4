...
public class AuthorizeTests
{
    ...
    {
        var response = await _mockPipeline.BrowserClient.GetAsync(IdentityServerPipeline.AuthorizeEndpoint, TestContext.Current.CancellationToken);
    ...
    {
        var response =
            await _mockPipeline.BrowserClient.PostAsync(IdentityServerPipeline.AuthorizeEndpoint, new StringContent("foo"), TestContext.Current.CancellationToken);
    ...
    {
        var response = await _mockPipeline.BrowserClient.PostAsync(IdentityServerPipeline.AuthorizeEndpoint, new FormUrlEncodedContent(
    ...
    public async Task signin_request_should_have_authorization_params(Type storeType)
    {
        ...
        var url = IdentityServerPipeline.CreateAuthorizeUrl(
            ...
            "123_nonce",
            "login_hint_value",
            "acr_1 acr_2 tenant:tenant_value idp:idp_value",
            extra: new
            {
        ...
        var response = await _mockPipeline.BrowserClient.GetAsync(url + "&foo=bar", TestContext.Current.CancellationToken);
